  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h2 className="text-2xl font-bold text-neutral-900 dark:text-white">Sistema de Grid</h2>
          <p className="text-neutral-600 dark:text-neutral-300">Layouts responsivos e sistemas de espaçamento</p>
        </div>
      </div>
